...
if __name__ == "__main__":
    ...
    u[int(1.0/dx)+3:] = 0.0
    # Smooth gaussian impulse
    # L = 6.0
    # sigma = 0.15
    # u[2:-2] = np.exp(-0.5*((x-L/10)/sigma)**2)
    ...
    with tqdm(total=int(t_final/dt)) as pbar:
        while t < t_final:
            ...
            u[0] = u[-4] # second to last interior
            u[1] = u[-3] # last interior
            u[-2] = u[2] # first interior
            u[-1] = u[3] # second interior
